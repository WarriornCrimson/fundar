...
<body>
    ...
    <div class="profile-container"> 
        ...
        <div class="profile-header-card">
            ...
            <div class="profile-actions"> 
                <a href="{{ route('edit-profile') }}" class="btn-edit" id="editProfileBtn">
                    <i class="fa-solid fa-pen"></i>
                    Account Settings
                </a>
                <a href="{{ route('student-verification') }}" class="btn-verification" id="verifyAccountBtn">
        ...
        <div class="tab-content active" id="portfolio">
            ...
            <div class="section-card">
                <div class="section-header">
                    ...
                    <button class="btn-primary" id="submitGradesBtn">
            ...
            <div class="section-card">
                <div class="section-header">
                    ...
                    <button class="btn-primary" id="addExperienceBtn">
                        <i class="fa-solid fa-plus"></i>
                        Add Experience
                    </button>
                </div>
    ...
    <div class="section-card">
        ...
        <!-- Campaign Sub-tabs -->
        <div class="campaign-sub-tabs">
            <button class="campaign-sub-tab-btn active" data-campaign-tab="live">
                <i class="fa-solid fa-circle-check"></i>
                Live Campaigns
            </button>
            <button class="campaign-sub-tab-btn" data-campaign-tab="pending">
                <i class="fa-solid fa-clock"></i>
                Pending Campaigns
            </button>
            <button class="campaign-sub-tab-btn" data-campaign-tab="closed">
                <i class="fa-solid fa-lock"></i>
                Closed Campaigns
            </button>
        </div>

        <!-- Live Campaigns Content -->
        <div class="campaign-sub-content active" id="live-campaigns">
            <div class="contains-campaigns">
                <x-user-campaign-card/>
                <!-- Add more live campaign cards here -->
            </div>
            <div class="empty-state" style="display: none;">
                <p>No live campaigns yet.</p>
            </div>
        </div>

        <!-- Pending Campaigns Content -->
        <div class="campaign-sub-content" id="pending-campaigns">
            <div class="contains-campaigns">
                <x-pending-user-campaign-card/>
                <!-- Add more pending campaign cards here -->
            </div>
            <div class="empty-state" style="display: none;">
                <p>No pending campaigns yet.</p>
            </div>
        </div>

        <!-- Closed Campaigns Content -->
        <div class="campaign-sub-content" id="closed-campaigns">
            <div class="contains-campaigns">
                <x-close-campaign-card/>
                <!-- Add more closed campaign cards here -->
            </div>
            <div class="empty-state" style="display: none;">
                <p>No closed campaigns yet.</p>
            </div>
        </div>
    </div>
</div>
